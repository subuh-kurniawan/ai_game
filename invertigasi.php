...
<head>
    ...
    <style>
        /* Custom styling untuk tema detektif/terminal */
        body {
        ...
        #game-log {
            height: 70vh;
            background-color: #16213e; /* Slightly lighter dark background for log */
            border: 2px solid #00b894; /* Neon green border */
            box-shadow: 0 0 15px rgba(0, 184, 148, 0.5); /* Glowing effect */
            overflow-y: auto;
            scroll-behavior: smooth;
            /* Pastikan lebar penuh dan tinggi proporsional */
            width: 100%;
        }
        .message-gm {
        ...
        /* Tombol diatur menggunakan grid di kontainer */
        #action-buttons-container button {
            transition: all 0.2s;
            white-space: normal; /* Biarkan teks tombol melilit */
            text-align: center;
        }

        /* Styling kustom untuk slider */
        #difficulty-slider {
        ...
        #difficulty-slider::-webkit-slider-thumb {
            ...
            cursor: pointer;
            border-radius: 50%;
            border: 3px solid #1a1a2e; /* Dark border to make it pop */
...
<body class="p-4 sm:p-8 flex flex-col min-h-screen text-white">
    ...
    <div class="max-w-4xl mx-auto w-full">
        <header class="text-center mb-6">
            <h1 class="text-3xl sm:text-4xl font-bold terminal-text">Detektif AI: Jejak Kasus</h1>
            <p class="text-lg text-gray-400 mt-1">AI Game Master</p>
        </header>

        <!-- Area Pemilihan Tema Awal -->
        <div id="theme-selector" class="bg-gray-800 p-6 sm:p-8 rounded-xl shadow-2xl transition duration-500">
            ...
            <div class="space-y-4 mb-6">
                ...
                <select id="theme-select" class="w-full p-3 rounded-lg bg-gray-700 text-white border-2 border-gray-600 focus:ring-00b894 focus:border-00b894 transition duration-300">
                ...
                <input
                    ...
                    class="w-full p-3 rounded-lg bg-gray-700 text-white border-2 border-gray-600 focus:ring-00b894 focus:border-00b894 transition duration-300 placeholder-gray-400"
                >
            </div>
            ...
            <!-- KONTROL TTS -->
            <div class="mt-6 flex items-center justify-between p-3 bg-gray-700 rounded-lg border border-gray-600">
        ...
        <div id="game-container" class="hidden">
            <div id="game-log" class="p-4 mb-6 rounded-lg shadow-xl transition duration-300">
            ...
            <!-- Container Tombol Tindakan Cepat (DIUBAH UNTUK RESPONSIVITAS) -->
            <div id="action-buttons-container" class="mt-4 mb-6 grid gap-3 p-4 bg-gray-800 rounded-xl shadow-inner border border-gray-700
            ...
            <div class="flex flex-col gap-3">
                <div class="flex gap-2 items-center w-full">
                    <input
                        ...
                        class="flex-grow w-full p-3 rounded-lg bg-gray-700 text-white border-2 border-gray-600 focus:ring-00b894 focus:border-00b894 transition duration-300 placeholder-gray-400"
                ...
                <button
                    id="send-button"
                    onclick="sendMessage()"
                    class="w-full bg-00b894 hover:bg-00cec9 text-yellow-300 font-bold py-3 px-6 rounded-lg transition duration-300 shadow-md flex items-center justify-center disabled:opacity-50 mt-2"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 mr-2">
        ...
        <!-- Area Resume Permainan (Baru) -->
        <div id="game-resume" class="p-6 sm:p-8 rounded-xl shadow-2xl transition duration-500 hidden">
    ...
    if (loading) {
        ...
        <div class="flex items-center justify-center text-white">
            <svg class="animate-spin -ml-1 mr-3 h-5 w-5 text-cyan-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
            </svg>
            <span class="font-medium text-cyan-100">Memproses...</span>
        </div>`;
        
        // Warna tombol saat loading
        sendButton.className = "flex items-center justify-center bg-gradient-to-r from-blue-500 to-cyan-400 text-white font-semibold py-2 px-4 rounded-lg shadow-lg opacity-90 cursor-not-allowed transition-all duration-300";
        ...
        <div class="flex items-center justify-center text-white">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                class="w-5 h-5 mr-2 text-white drop-shadow-md">
                <path d="M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z"></path>
            </svg>
            <span class="font-medium tracking-wide">Kirim Tindakan</span>
        </div>`;
        
        // Warna tombol aktif
        sendButton.className = "flex items-center justify-center bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-500 hover:from-cyan-500 hover:to-indigo-500 text-white font-semibold py-2 px-4 rounded-lg shadow-xl transition-all duration-300 hover:scale-[1.02]";
        
        // Fokuskan kembali input teks
        playerInput.focus();
    }
}
            ...
            if (actions && actions.length > 0) {
                actions.forEach(action => {
                    ...
                    if (trimmedAction) {
                        ...
                        // Hapus flex-grow di sini karena kontainer sudah grid
                        button.className = 'px-4 py-2 bg-pink-600 hover:bg-pink-700 text-white font-medium rounded-lg transition duration-200 shadow-md';
                        button.onclick = () => {
